...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
         => optionsBuilder.UseSqlServer("Data Source=DESKTOP-48961G1;Initial Catalog=FUMiniHotelManagement;Persist Security Info=True;User ID=sa;Password=123;Encrypt=False");
    ...
    {   
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A1474097C054FE").IsUnique();
